...
export async function PATCH(req: NextRequest) {
  ...
  if (!userId || !role) return apiError(ApiError.badRequest("userId and role are required."));
  if (!Object.values(UserRole).includes(role)) return apiError(ApiError.badRequest("Invalid role."));
