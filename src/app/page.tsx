    ...
    <div className="min-h-screen bg-background text-foreground overflow-x-hidden">
      <section className="relative min-h-screen flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <Image alt="family" className="w-full h-full object-cover opacity-25" height={2000} src="/images/people.png" width={2000} />
        ...
        <div className="relative z-10 flex flex-col items-center text-center max-w-3xl px-4 pt-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Button size="lg" className="text-lg px-8 py-6 h-auto shadow-lg shadow-primary/20" asChild>
      ...
      <section className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-primary mb-3">Everything Your Family Needs</h2>
          <p className="text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Ukoo is designed with African family structures in mind — from multi-generational clans to diaspora connections.
          </p>
      ...
      <section className="py-20 px-4 text-center">
        <h2 className="text-3xl font-bold text-primary mb-4">Your Roots Are Waiting</h2>
        <p className="text-muted-foreground mb-8 max-w-xl mx-auto">
          Every story deserves to be remembered. Start preserving your family&apos;s history today.
        </p>
      ...
      <footer className="border-t border-border py-8 px-4 text-center text-muted-foreground text-sm">
        <p>
          ...
          <a href="https://odutechspace.com" className="text-primary hover:underline">
            Odutechspace
          </a>
        </p>
      </footer>
